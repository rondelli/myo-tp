...
\noindent $M_{si}$: constante, toma la cantidad de archivos de tamaño $s_{i}$ que entran en un disco de tamaño $d$. Nótese que esto es equivalente a $int(toMB(d) / s)$.
...
\begin{alignat*}{2}
	...
	& z_{sj} \cdot M_{si} \leq \sum_{i=1}^{n} x_{ij} \quad \text{si } S_i = s, \quad \forall s \in S, \, \forall j \in \{1, \ldots, m\}, \forall i \in \{1, \ldots, n\} \text{(marcamos los tamaños que están en cada disco)} \\
...
Sección~\ref{quinta:parte}.

Para agilizar el algoritmo, investigamos en la documentación de
PySCIPOpt con el objetivo de identificar los parámetros y
...
f0015.in |  15  |    8.0   |  8.0   | 240  | 0.0 | 8.0              | 240  |  0.0 | 7.666666666666667 | 43   | 0.0 | 0      | 0    | 0
f0018.in |  18  |   10.0   |  8.0   | 240  | 0.0 | 9.999999544151857| 342  | 98.0 | 9.166666666666666 | 69   | 0.0 | 0      | 0    | 0
f0032.in |  32  |   16.5   |  8.0   | 240  | 0.0 | 9.999999544151857| 342  | 98.0 | 16.5              | 285  | 0.0 | 0      | 0    | 0
\end{verbatim}
\end{minipage}
\end{turn}
