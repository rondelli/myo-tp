...
archivos, considerando la capacidad de cada disco y el tamaño de cada archivo. 

\subsection{Modelo Lineal}

Para minimizar la cantidad de discos, utilizamos una variable binaria que nos indica si se esta usando un disco o no y otra para identificar si cada archivo pertenece al disco j. Luego, armamos 3 restricciones principales: la primera se asegura que no cada archivo no esté dividido; la segunda, que los tamaños de los archivos de cada disco no superen la capacidad del disco (siempre y cuando se esté usando ese disco); y la tercera define que ningún disco quede vacío (sería equivalente a la implicación $x_{ij} \implies y_i$
...
\lstinputlisting[inputencoding=utf8/latin1,language=Python]{segunda-parte/main.py}
\newpage
