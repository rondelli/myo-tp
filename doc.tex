...
Esta función recibe los datos leidos de un archivo de configuración creado 
...
\lstinputlisting[inputencoding=utf8/latin1,language=Python]{primera-parte/generador_output.py}
