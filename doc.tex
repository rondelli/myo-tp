...
que abarcan desde el modelado directo en \emph{SCiP} hasta la
implementación de algoritmos en Python con la biblioteca
\emph{PySCIPOpt}. A lo largo del trabajo, se considerarán restricciones
...
\subsubsection{Pseudocódigo de alto nivel}

\newpage
\section{Parte 6}
\subsection{Descripción}
En esta sección, se explican mejoras al algoritmo de la sección 5.
