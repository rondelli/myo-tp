...
Este trabajo práctico tiene como objetivo aplicar conceptos de modelado y optimización utilizando técnicas de programación lineal y tecnologías. Buscamos, a través de una serie de problemas relacionados con la gestión de archivos en una empresa de datos, diseñar soluciones eficientes que optimicen el uso de recursos, como el almacenamiento en discos y la importancia de los datos.

La actividad se divide en seis partes, cada una con enfoquesespecíficos que abarcan desde el modelado directo en \emph{SCiP} hasta la implementación de algoritmos en Python con la biblioteca \emph{PySCIPOpt}. A lo largo del trabajo, se considerarán restricciones como la capacidad limitada de los discos, la importancia de los archivos y la estructura de conjuntos para maximizar la eficiencia del almacenamiento y la relevancia de los datos seleccionados.
\newpage
\section{Desarrollo}
\subsection{Parte 1}
...
archivo. 
\subsubsection{Modelo Lineal}\label{modelo:primera:parte}
...
$s_{i}$ constante: tamaño del archivo $i$ en MB, con $i = 1, \ldots, n$. \\
